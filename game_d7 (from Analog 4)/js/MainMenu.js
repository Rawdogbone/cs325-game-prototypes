...
GameStates.makeMainMenu = function( game, shared ) {
    ...
    create: function () {
            ...
            // MENU TEXT
            // Title Text
            var style = { font: "bold 45px forte", fill: "#fff", align: "center" };
            ...
            // version Num
            var style = { font: "bold 20px Consolas", fill: "#fff", align: "center" };
            var text2 = game.add.text( game.world.centerX, 100, "version 1.0 Alpha", style );
            text.anchor.setTo( 0.5, 0.0 );
            game.world.bringToTop(text);
            text2.setShadow(3, 3, 'rgba(0,0,0,1)', 5);

            var style = { font: "17px forte", fill: "#fff", align: "center" };
            var text3 = game.add.text( 585, 575, "A Game by Joseph Bessette", style );
            text.anchor.setTo( 0.5, 0.0 );
            game.world.bringToTop(text);
            text3.setShadow(3, 3, 'rgba(0,0,0,1)', 5);
            ...
            game.world.bringToTop(rulesButton);
            game.world.bringToTop(storyButton);
            game.world.bringToTop(text);
